...
$sph_messages =  Array (
	...
	"Search" => "Arama Yap",
	"All sites" => "Bütün Siteler",
	"Web pages" => "Web Sayfalarý",
	"noMatch" => "Arama Sonucunda \"%query\" Konu Ýle Ýlgili Bir Dokuman Bulunamamýþtýr.", 
	"ignoredWords" => "Following words were ignored (too short or common): %ignored_words",
	"resultsFor" => "Ýçin sonuçlar:",
